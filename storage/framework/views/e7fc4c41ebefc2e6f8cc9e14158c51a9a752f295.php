...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/newbill.css')); ?>">
...
<body>
  <header>
    ...
    <a href="<?php echo e(url('/')); ?>" class="home-icon">
  ...
  <div class="container">
    <form action="<?php echo e(route('new.store')); ?>" method="POST">
      <?php echo csrf_field(); ?> <!-- لحماية من الهجمات Cross-Site Request Forgery -->
    ...
    $(document).ready(function() {
      ...
      $('#car_code').on('blur', function() {
        ...
        if (carCode) {
          ...
          $.ajax({
            url: '<?php echo e(route('getCarDetails')); ?>', // الرابط الذي يوجه إلى الدالة في الـ Controller
...
<?php /**PATH C:\Users\emad.j\Desktop\prog\cmder\car_sealer\resources\views/newbill.blade.php ENDPATH**/ ?>